...
// Bridge to the shared engine (@receiptly/core). It runs server-side over
// Postgres; Next transpiles the package (see next.config transpilePackages).
// Import from the specific modules, not the package barrel: the barrel
// re-exports session.ts, which value-imports Playwright (a server-only native
// module) and breaks the Next bundle. These are pure DB reads.
export {
  listTransactions,
  getTransaction,
  merchantSummary,
...
export { DEFAULT_USER_ID } from "@receiptly/core/lib/constants.js";

export type { Connector } from "@receiptly/core/connectors/index.js";
